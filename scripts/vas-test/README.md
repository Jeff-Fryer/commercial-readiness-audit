...
| 11. The POST | 37 fields, none of them a deal value |
| 15a. No newsletter | No checkbox, element, CSS or hidden-twin field for a mailing-list opt-in, checked in the rendered screen and the served file |
